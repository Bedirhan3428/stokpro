import "../styles/Home.css"; // Yeni CSS dosyasını import ediyoruz import React from "react" import f useNavigate ) from "react-router-dom"; import (getAuth ) from "firebase/auth"; import Info from "./info":
<
export default function Home() f const nav = useNaviqate () const auth = getAuth() const user = auth.currentUser:
return (

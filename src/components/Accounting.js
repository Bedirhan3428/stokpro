    ...
    <div className="page-container">
      ...
      <div className="prd-card" style={{ marginBottom: '16px', padding: '14px 16px' }}>
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          {/* 1. METİN ARAMASI */}
          <div className="input-icon-wrapper" style={{ flex: '1 1 200px', minWidth: '180px' }}>
                  ...
                  <React.Fragment key={`group_${gIdx}`}>
                    ...
                    {group.items.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <button onClick={() => faturaGoster(item)} className="tbl-btn primary" style={{ padding: '4px 10px', fontSize: '0.8rem' }}>
                            <FiPrinter size={14} /> Fatura
                          </button>
                        </td>
                      </tr>
                    ))}

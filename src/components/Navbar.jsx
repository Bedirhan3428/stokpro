...
export default function Navbar() {
  ...
  // Mobil menü açıldığında arkadaki sayfayı kilitle (Scroll engelle)
  useEffect(() => {
    if (mobileOpen) {
  ...
  // --- MOBİL MENÜ BİLEŞENİ (PORTAL İÇİN) ---
      ...
      <div className="nb-mobil-menu">
        ...
        <div className="nb-mobil-footer">
          ...
          <div className="nb-mobil-aksiyonlar">
            <button onClick={() => {setMobileOpen(false); nav("/settings");}} className="nb-btn-outline">Ayarlar</button>
  ...
  return (
    <>
                  ...
                  {open && (
                    <div className="nb-dropdown">
                      ...
                      <div className="nb-dropdown-items">
                        <button onClick={() => {setOpen(false); nav("/settings");}}>Ayarlar</button>
      ...
      {/* PORTAL KULLANIMI: Menüyü document.body'ye taşıyoruz */}
      {user && mobileOpen && ReactDOM.createPortal(
        <MobileMenuOverlay />,
        document.body
      )}
    </>
